...
username = "amhackers2017@yandex.com" # Here enter your API user name
password = "o6W2EqJn95QeFk4d8" # Here enter your API password
...
language = "en-gb" # en-gb, de-ch, fr-fr, es-es, tr-tr, sk-sk...
